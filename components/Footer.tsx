      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/categories?category=electronics" className="text-gray-400 hover:text-white">Electronics</Link></li>
              <li><Link href="/categories?category=home" className="text-gray-400 hover:text-white">Home & Kitchen</Link></li>
              <li><Link href="/categories?category=fashion" className="text-gray-400 hover:text-white">Fashion</Link></li>
              <li><Link href="/categories?category=sports" className="text-gray-400 hover:text-white">Sports & Fitness</Link></li>
              <li><Link href="/categories?category=toys" className="text-gray-400 hover:text-white">Toys & Games</Link></li>
              <li><Link href="/categories?category=beauty" className="text-gray-400 hover:text-white">Beauty</Link></li>
            </ul>
          </div>
